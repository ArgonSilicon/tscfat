...
def main():
    ...
    #sl.(r'/home/arsi/Documents/Data/Studentlife_cherry_data.csv', header=True)
    ...
    sl.to_csv(r'/home/arsii/Data/Studentlife_cherry_data.csv', header=True)
    ...
    df_act = sl[(sl['id'] == i) & (sl['type'] == 'activity') ].value.resample('D').sum()
