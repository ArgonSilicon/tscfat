...
def process_screen_events(df):
    ...
    fig.suptitle("Screen Unlock Events",fontsize=20,y=0.93)
    ...
    ax[0,1].set_title('Screen Event Count variance',fontsize=16)
    ...
    ax[1,0].set_title('Screen Event Count autocorrelation(1)',fontsize=16)
    ...
    ax[1,1].set_title('Screen Event Count rolling window(7) mean',fontsize=16)
