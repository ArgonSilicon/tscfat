...
def process_battery(df,FIGPATH):
    ...
    FIGPATH = Path(r'/u/26/ikaheia1/data/Documents/SpecialAssignment/CS-special-assignment/Results/Decomposition')
    ...
    FIGPATH = Path(r'/u/26/ikaheia1/data/Documents/SpecialAssignment/CS-special-assignment/Results/RollingStatistics')
    FIGNAME = "Battery_level_Rolling_Statistics"
    ...
    FIGPATH = Path(r'/u/26/ikaheia1/data/Documents/SpecialAssignment/CS-special-assignment/Results/Similarity')
    ...
    FIGPATH = Path(r'/u/26/ikaheia1/data/Documents/SpecialAssignment/CS-special-assignment/Results/Clusters')
